...
class Graph extends event_emitter_1.default {
    ...
    async initCanvas() {
        ...
        const { container = 'container', width, height, renderer, cursor, background, devicePixelRatio = window.devicePixelRatio ?? 1, } = this.options;
    ...
    async frontElement(id) {
        ...
        ids.map((_id) => {
            ...
            if (elementType === 'combo') {
                ...
                const combos = [ancestor, ...model.getDescendantsData((0, id_1.idOf)(ancestor))];
                ...
                const { internal } = (0, edge_1.getSubgraphRelatedEdges)(combos.map(id_1.idOf), (id) => model.getRelatedEdgesData(id));
