...
class Animation {
    ...
    inferStyle(context, options) {
        ...
        if (stage === 'enter') {
            ...
            Object.assign(fromStyle, { opacity: 0 });
            Object.assign(toStyle, { opacity: (0, cache_1.getCachedStyle)(element, 'opacity') ?? (0, animation_1.inferDefaultValue)('opacity') });
        }
        else if (stage === 'hide') {
            Object.assign(fromStyle, { opacity: (0, cache_1.getCachedStyle)(element, 'opacity') ?? (0, animation_1.inferDefaultValue)('opacity') });
            Object.assign(toStyle, { opacity: 0 });
        }
