...
class BaseCombo extends nodes_1.BaseNode {
    ...
    getCollapsedMarkerStyle(attributes) {
        if (!attributes.collapsed || !attributes.collapsedMarker)
            return false;
        const { type, ...collapsedMarkerStyle } = (0, prefix_1.subStyleProps)(this.getGraphicStyle(attributes), 'collapsedMarker');
    ...
    getComboZIndex(attributes) {
        const ancestors = this.context.model.getAncestorsData(this.id, constants_1.COMBO_KEY) || [];
