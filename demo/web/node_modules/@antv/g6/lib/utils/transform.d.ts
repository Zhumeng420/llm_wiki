 ...
 */
export declare function replaceTranslateInTransform(x: number, y: number, z: number, transform?: string): string;
/**
 * <zh/> 重新分配绘制任务
 *
 ...
 */
export declare const reassignTo: (input: DrawData, type: "add" | "update" | "remove", elementType: ElementType, datum: ElementDatum, merge?: boolean) => void;
