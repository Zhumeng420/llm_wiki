...
class ZoomCanvas extends base_behavior_1.BaseBehavior {
    ...
    bindEvents() {
        ...
        if (Array.isArray(trigger)) {
            this.context.canvas.getContainer()?.addEventListener(constants_1.CommonEvent.WHEEL, this.preventDefault);
    ...
    destroy() {
        ...
        this.context.canvas.getContainer()?.removeEventListener(constants_1.CommonEvent.WHEEL, this.preventDefault);
        super.destroy();
    }
}
