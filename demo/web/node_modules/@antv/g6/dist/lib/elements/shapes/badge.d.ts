...
export declare class Badge extends BaseShape<BadgeStyleProps> {
    ...
    protected getBadgeStyle(attributes: Required<BadgeStyleProps>): Omit<Required<BadgeStyleProps>, "x" | "y" | "z" | "class" | "transform" | "transformOrigin" | "visibility" | "zIndex" | "context" | "className">;
